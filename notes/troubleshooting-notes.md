...
## 14. General Troubleshooting Principle
...
Identify the evidence gap
        |
        v
Use another available evidence source
        |
        v
Correlate
        |
...
Accurate documentation of evidence limitations is an important part of DFIR and SOC investigation work.
